...
class HomePageTest(unittest.TestCase):
    ...
    def setUp(inst):
        ...
        inst.driver = webdriver.Chrome(executable_path='/home/tibil/Chetan/chromedriver_linux64/chromedriver')
    ...
    #     self.assertTrue(self.is_element_present(By.ID,"fakebox-input"))
    ...
    def test_language_settings(self):
        ...
        #self.assertTrue(self.is_element_present(By.XPATH,"[data-pid='23']"))
